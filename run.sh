...
data=/cs/engproj/speech/SpeechCourpus2/my_data
...
steps/train_mmi.sh  data/train_10k data/lang_nosp exp/tri2b_ali_10k exp/tri2b_denlats exp/tri2b_mmi
  for test in test_clean test_other dev_clean dev_other; do
    steps/decode.sh --config conf/decode.config --iter 4 --nj 20 --cmd "$decode_cmd" \
	  exp/tri2b/graph_nosp_tgsmall data/$test exp/tri2b_mmi/decode_it4_$test
	steps/decode.sh --config conf/decode.config --iter 3 --nj 20 --cmd "$decode_cmd" \
	  exp/tri2b/graph_nosp_tgsmall data/$test exp/tri2b_mmi/decode_it3_$test
  done
...
steps/make_denlats.sh --config conf/decode.config \
   --nj 20 --cmd "$train_cmd" --transform-dir exp/tri3b_ali_clean_100 \
...
for test in test_clean test_other dev_clean dev_other; do
	...
	steps/decode.sh --config conf/decode.config --nj 20 --cmd "$decode_cmd" \
	  --transform-dir exp/tri3b/decode_nosp_tgsmall_$test  exp/tri3b/graph_nosp_tgsmall data/$test exp/tri3b_mmi/decode2_$test
done
...
for iter in 3 4 5 6 7 8; do
	...
	for test in test_clean test_other dev_clean dev_other; do
		...
		--transform-dir exp/tri3b/decode_nosp_tgsmall_$test  exp/tri3b/graph_nosp_tgsmall data/$test exp/tri3b_fmmi_b/decode_it$itTest &
	done
done
...
for iter in 3 4 5 6 7 8; do
  for test in test_clean test_other dev_clean dev_other; do
  	itTest=$iter_$test
	steps/decode_fmmi.sh --nj 20 --config conf/decode.config --cmd "$decode_cmd" --iter $iter \
      --transform-dir exp/tri3b/decode_nosp_tgsmall_$test  exp/tri3b/graph_nosp_tgsmall data/$test exp/tri3b_fmmi_c/decode_it$iTest &
   done
...
for iter in 3 4 5 6 7 8; do
   for test in test_clean test_other dev_clean dev_other; do
		itTest=$iter_$test
		steps/decode_fmmi.sh --nj 20 --config conf/decode.config --cmd "$decode_cmd" --iter $iter \
		  --transform-dir exp/tri3b/decode_nosp_tgsmall_$test  exp/tri3b/graph_nosp_tgsmall data/$test exp/tri3b_fmmi_d/decode_it$itTest &
	done
done
